...
import { useAttendance } from './AttendancePage';
        ...
        <div>
          {!clockInStatus ? (
            <button
              ...
              className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl text-white bg-blue-500 hover:bg-blue-600"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl text-white bg-green-500 hover:bg-green-600"
            >
              <ClipboardCheck className="h-4 w-4" />
              下班打卡
            </button>
            ...
            <button
              disabled
              className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl text-white bg-gray-400 cursor-not-allowed"
            >
              <ClipboardCheck className="h-4 w-4" />
              今日已打卡
            </button>
