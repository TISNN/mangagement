...
const FEATURED_GARDENS: GardenCard[] = [
  {
    ...
    cover: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=960&q=80',
    ...
    priceLabel: 'FREE',
    priceType: 'free',
    author: { name: '导师管理中心', avatar: 'https://i.pravatar.cc/80?img=12' },
  },
  {
    id: 'g2',
...
const DISCOVER_CONTENT: Record<string, GardenCard[]> = {
  ...
  'For Advisors': [
    ...
    },
    {
      ...
      cover: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=960&q=80',
