...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const isActive = (path: string) => {
    return location.pathname === `/website${path}`;
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link to="/website" className="text-gray-400 hover:text-white transition-colors">
                    主页
                  </Link>
                </li>
                <li>
                  <Link to="/website/about" className="text-gray-400 hover:text-white transition-colors">
                    关于我们
                  </Link>
                </li>
                <li>
                  <Link to="/website/pricing" className="text-gray-400 hover:text-white transition-colors">
                    价格
                  </Link>
                </li>
                <li>
                  <Link to="/website/contact" className="text-gray-400 hover:text-white transition-colors">
                    联系我们
                  </Link>
                </li>
              </ul>
