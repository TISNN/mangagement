    ...
    for index, row in df.iterrows():
        ...
        if school_id:
            program = {
                ...
                'tuition_fee': str(row.get('tuition', '')),
        ...
        for i in range(1, len(lines)):
            ...
            if parts[0].strip().isdigit():
                ...
                if len(parts) > 1:
                    ...
                    current_program['tuition_fee'] = parts[9].strip() if len(parts) > 9 else ''
...
# 生成SQL语句
if programs:
    sql_file = '/Users/evanxu/Downloads/project/import_programs.sql'
    with open(sql_file, 'w', encoding='utf-8') as f:
        f.write("-- 插入programs表数据\n")
        for program in programs:
            ...
            sql = f"""INSERT INTO public.programs (
                ...
                '{program['duration']}', '{program['tuition_fee']}', '{program['apply_requirements']}',
