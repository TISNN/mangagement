...
> 目标：为知识花园打造沉浸式浏览体验，兼顾学生、顾问/内部员工、B 端合作伙伴与第三方创作者。以下方案从信息架构、视觉风格、关键版块与交互细节入手，可直接指导设计/前端实现。
...
---
此方案严格参照截图风格并扩展为完整知识花园体验，后续可结合 `knowledge-garden-frontend.md` 中的路由规划与后台模块共同推进开发。