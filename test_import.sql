...
INSERT INTO public.programs (
    ...
    '1年', '49050新币/年', '- 具有良好的学士学位 - 具有良好的GMAT（600+）/GRE（Verbal和Quantitative均分156+）/SMU入学考试（Verbal/Numerical/Integrated Reasoning均分55+）成绩 *EQ方向要求定量部分成绩优秀 8月入学学费40,330新币，1月入学学费49,050新币',
...
INSERT INTO public.programs (
    ...
    '1年(全日制）/2年(非全日制)', '39000新币/年', '具有学士学位，包含很强的信息技术相关成分，例如工程或科学；或 具有学士学位，需要工程或相关学科背景并受过数学训练，同时具备2年相关行业经验。',
    NOW(), NOW(), '无', '无',
...
INSERT INTO public.programs (
    ...
    '1年（全日制）', '3.8万新币/年', '必须在毕业后具备至少2年相关全职工作经验，相关工作经验包括在社区、学校、诊所或同等环境中为高危人群或弱势群体提供咨询 学校只会考虑具备适合辅导专业的个人特质及才能并有潜力为社会作出贡献的申请者，对获得MACG学位后成为专业咨询师有明确职业道路的申请者将优先考虑',
    NOW(), NOW(), '无', '无',
    '教育, 咨询, 教育学院', '无', '教育学院',
    '心理学', '1月/7月', '无',
...
INSERT INTO public.programs (
    ...
    '1年（全日制）', '33800新币/年', '具有学士学位以及相关工作经验，偏好K-12教育、教师专业发展、继续教育和培训或其他相关成人教育；或 具备1年工作经验（需要提供工作证明/受雇证明）',
...
INSERT INTO public.programs (
    ...
    '1年（非全日制）', '31030新币/年', '招生特点：申请者需要将材料电邮至mailto:mme-c@ntu.edu.sg，并且必须将文件名加上姓名和申请号码后以PDF格式分开放在附件发送，否则项目可能无法打开压缩包。在录取背景方面，该课程主要面向985、财经211或海本背景的申请者，特别是商科尤其是经济类专业的学生。湖南大学的商科等合适专业、GPA84以上的申请者目前有100%的申请成功率。该课程分别开 设了7月班和11月班，其中7月班入学即为秋招，需要在6月30日确认毕业，7月中下旬发放证书和毕业典礼；11月班则是在结课时进行秋招，第三年1月毕业。',
    NOW(), NOW(), '无', '无',
